 ...
 *  
 */  
public class HttpClientKeepSession implements Serializable{  
  
        private static final long serialVersionUID = -2990044109279805503L;
                private static final Logger LOG = LogManager.getLogger(HttpClientKeepSession.class);  
        ...
        private static void init() {  
            ...
            requestConfig = RequestConfig.custom()
                           .setConnectTimeout(120000).setSocketTimeout(60000)  
        ...
        public static CloseableHttpResponse get(String url) throws ClientProtocolException, IOException {  
            ...
            httpget.setHeader("User-Agent", "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36"); // 设置请求头消息User-Agent
...
//                        LOG.debug("key:" + cookie.getName() + "  value:" + cookie.getValue());  
         ...
         *   
         */  
        public static void printCookies(String name) {  
